...
import 'package:bai_tap_trainee/ui/pages/chap_6/chap_6_home/widgets/carousel_slider_backdrop_path_widget.dart';
import 'package:bai_tap_trainee/ui/pages/chap_6/chap_6_home/widgets/carousel_slider_poster_path_widget.dart';
import 'package:bai_tap_trainee/ui/pages/chap_6/chap_6_home/widgets/menu_item_widget.dart';
...
import 'chap_6_home_cubit.dart';

class Chap6HomeArguments {
  String param;
...
class Chap6HomePage extends StatelessWidget {
  const Chap6HomePage({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        ...
        return Chap6HomeCubit(movieRepository: movieRepository);
      },
      child: const Chap6HomeChildPage(),
    );
  }
}

class Chap6HomeChildPage extends StatefulWidget {
  const Chap6HomeChildPage({Key? key}) : super(key: key);

  @override
  State<Chap6HomeChildPage> createState() => _Chap6HomeChildPageState();
}

class _Chap6HomeChildPageState extends State<Chap6HomeChildPage> {
  late final Chap6HomeCubit _cubit;
  ...
  Widget _buildBodyWidget() {
    return BlocBuilder<Chap6HomeCubit, Chap6HomeState>(
      bloc: _cubit,
